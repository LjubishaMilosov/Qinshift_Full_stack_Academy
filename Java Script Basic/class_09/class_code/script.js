...
jQuery(function() { 
    ...
    let innerWrappers = $(".innerWrapper");
    console.log(innerWrappers);
    console.log(innerWrappers[0].innerText);
    ...
    let lastChild = $("p:last-child"); // get all p elements that are last child of their parent(of any type:p/h1/h3 etc.)
    console.log(lastChild);

    let lastChildH3 = $("h3:last-child"); // get all h3 elements that are last child of their parent. 
    console.log(lastChildH3[0]);
...
// 
    ...
    // // After & Before
    paragraphs.last().after("<h2>This is after header</h2>");
